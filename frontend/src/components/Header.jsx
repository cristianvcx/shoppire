      ...
      <div className="max-padd-container flexBetween">
        ...
        <div className="flexBetween gap-x-2 xs:gap-x-8">
          ...
          <Link to={'/cart'} className="flex relative">
            ...
            <span className="bg-secondary text-white medium-14 absolute right-0.5 -top-3 flexCenter w-5 rounded-full shadow-inner">0</span>
          </Link>
          ...
          <div className="group relative">
            ...
            {token && <>
              <ul className="bg-white shadow-sm p-3 w-32 ring-1 ring-slate-900/5 rounded absolute right-0 hidden group-hover:flex flex-col">
